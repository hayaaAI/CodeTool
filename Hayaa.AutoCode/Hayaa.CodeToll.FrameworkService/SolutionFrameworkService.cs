  ...
  public  interface SolutionFrameworkService
    {
        ...
        /// <returns></returns>
        FunctionResult<Solution> MakeCodeForMultiStoreySolution(List<String> tables, SolutinTemplate codeTemplatee, String databaseConnection, String databaseName, String savePath);
        /// <summary>
        /// 生成Dao层代码，保存至指定位置
        /// </summary>
