    ...
    export default {
        ...
        methods: {
            ...
            getPager: function(page) {
                var that = this;
                httphelper.authedpostform(webstore.urls.codeTemplateGetListUrl, {"solutionTemplateId": that.solutionTemplateId},
                    function (data) {
            ...
            del: function(id) {
                var that = this;
                httphelper.authedpostform(webstore.urls.codeTemplateDeleteUrl, {"id": id},
                    function (data) {
                        if(data)
