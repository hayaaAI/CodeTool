        ...
        this.$refs[formName].validate(function (valid) {
          if (valid) {
            if (that.ruleForm.codeTemplateId == 0) {
              that.ruleForm.solutionTemplateId = that.solutionTemplateId;
              httphelper.authedpostform(webstore.urls.codeTemplateAddUrl, that.ruleForm,
                function (data) {
                  that.back();
                });
            } else {
              httphelper.authedpostform(webstore.urls.codeTemplateEditUrl, that.ruleForm,
                function (data) {
                  if (data)
