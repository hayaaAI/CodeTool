...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            get: function(id) {
                var that = this;
                httphelper.authedpostform(webstore.urls.codeSolutionGetUrl, {"id": id},
                    function (data) {
                        that.ruleForm = data;
                    });
            },
                ...
                this.$refs[formName].validate(function(valid) {
                    if (valid) {
                        if (that.ruleForm.solutionTemplateId == 0) {
                            httphelper.authedpostform(webstore.urls.codeSolutionAddUrl, that.ruleForm,
                                function (data) {
                                    that.back();
                                });
                        } else {
                            httphelper.authedpostform(webstore.urls.codeSolutionEditUrl, that.ruleForm,
                                function (data) {
                                    if (data)
