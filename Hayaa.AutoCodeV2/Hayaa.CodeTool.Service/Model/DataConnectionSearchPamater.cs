...
{public class DataConnectionSearchPamater:SearchPamaterMariadbBase {public int? DataConnectionId{set;get;}
...
private String GetDataConnectionIdSqlForSharp(){String sql = "";switch (DataConnectionIdPOT){
...
public List<String> DatabaseHostList{set;get;}
private PamaterOperationType DatabaseHostPOT;
public void SetDatabaseHost(String info,PamaterOperationType pot){ this.DatabaseHost=info;this.DatabaseHostPOT=pot;}
private String GetDatabaseHostSqlForSharp(){String sql = "";switch (DatabaseHostPOT){
case PamaterOperationType.StringContains:sql = "DatabaseHost like '%@DatabaseHost%'";break;
case PamaterOperationType.Equal:sql = "DatabaseHost=@DatabaseHost";break;
case PamaterOperationType.GreaterEqual:sql = "DatabaseHost>=@DatabaseHost";break;
case PamaterOperationType.GreaterThan:sql = "DatabaseHost>@DatabaseHost";break;
case PamaterOperationType.LessEqual:sql = "DatabaseHost<=@DatabaseHost";break;
case PamaterOperationType.LessThan:sql = "DatabaseHost<=@DatabaseHost";break;
case PamaterOperationType.In:sql = "DatabaseHost in(" + String.Join(",", this.DatabaseHostList) + ")";break;
case PamaterOperationType.StringIn:sql = "DatabaseHost in('" + String.Join("','", this.DatabaseHostList)+"')";break;
}
return sql;}
...
private String GetDatabaseNameSqlForSharp(){String sql = "";switch (DatabaseNamePOT){
...
private String GetDatabaseUserSqlForSharp(){String sql = "";switch (DatabaseUserPOT){
...
private String GetDatabaseTokenSqlForSharp(){String sql = "";switch (DatabaseTokenPOT){
...
private String GetRemarkSqlForSharp(){String sql = "";switch (RemarkPOT){
